...
=> *4.FITUR SERVER(eror lagi di fix)*
_${BotName} akan mengirimkan info server!_
Perintah: #infoserver
Contoh: #infoserver

=> *5.FITUR LOLI*
_${BotName} akan mengirimkan gambar anime loli secara random!_
Perintah: #loli
Contoh: #loli
...
Perintah: #lirik [nama lagu]
Contoh: #lirik ampun bang jago

=> *14.FITUR ALAY*
_${BotName} akan mengirimkan teks alay sesuai perintah yang kamu kirim!_
Perintah: #alay [kata kata]
Contoh: #alay aku ganteng:v

=> *15.FITUR HENTAI*
_${BotName} akan mengirimkan foto anime hentai sesuai perintah yang kamu kirim!_
Perintah: #hentai
Contoh: #hentai

=> *16.WIKIPEDIA(undefined)*
_${BotName} akan mengirimkan hasil dari wikipedia sesuai perintah yang kamu kirim!_
Perintah: #wiki [query]
Contoh: #wiki sultan

=> *16.FITUR INTRO*
_${BotName} akan mengirimkan pesan intro sesuai perintah yang kamu kirim!_
Perintah: #intro
Contoh: #intro
